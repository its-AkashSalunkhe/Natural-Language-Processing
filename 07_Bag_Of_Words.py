...
for i in range(len(sentences)):
    ...
    # example - Hello!!! I have 2 dogs
    # we apply re.sub('[^a-zA-Z]',' ', ...) 
    # becomes --->> Hello    I have   dogs     
    # Everything except alphabets becomes spaces.
...
# Now notice the table created by TF-IDF since there is "Log" function we get decimal values, and all values are mostly different (since the values are different we easily get to know what thing we are taling about from the table)
